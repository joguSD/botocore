...
from botocore.exceptions import (
    ...
    ReadTimeoutError, ProxyConnectionError, H2ConfigurationError
)
try:
...
try:
    ...
    class HyperSession(object):
        ...
        HTTP/2. This implements some degree of connection pooling to maximise
        the HTTP/2 gain.
        """
        def __init__(self,
                     verify=True,
        ...
        def send(self, request):
            ...
            try:
                ...
                if not request.stream_output:
                    # Cause the raw stream to be exhausted immediately. We do
                    # it this way instead of using preload_content because
                    # preload_content will never buffer chunked responses
                    http_response.content
    ...
    class HyperSession(object):
        def __init__(self, *args, **kwargs):
            error_msg = 'Failed to load optional H2 dependencies'
